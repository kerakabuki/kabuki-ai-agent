...
const SCENES = [
  {
    ...
    cues: [
      // ===== 花道 ─ 登場と一人ずつの見得 =====
      { time: 8,   text: "待ってました！", hint: "五人男の登場" },

      // 花道での見得（02:36〜05:29 やりとりの中で一人ずつ）
      { time: 170, text: "よっ！",         hint: "日本駄右衛門の花道見得" },
      { time: 200, text: "待ってました！", hint: "弁天小僧の花道見得" },
      { time: 230, text: "よっ！",         hint: "忠信利平の花道見得" },
      { time: 260, text: "待ってました！", hint: "赤星十三郎の花道見得" },
      { time: 290, text: "よっ！",         hint: "南郷力丸の花道見得" },

      // ===== つらね ─ 名乗りの開始と終わり =====
      // 日本駄右衛門（05:29〜）「問われて名乗るもおこがましいが…」
      { time: 332, text: "待ってました！", hint: "日本駄右衛門の名乗り" },
      { time: 390, text: "たっぷりと！",   hint: "駄右衛門のつらね終わり" },

      // 弁天小僧菊之助（06:41〜）「続いて次に控えしは…」
      { time: 404, text: "待ってました！", hint: "弁天小僧の名乗り" },
      { time: 458, text: "たっぷりと！",   hint: "弁天小僧のつらね終わり" },

      // 忠信利平（07:46〜）「またその次に連なるは…」
      { time: 470, text: "待ってました！", hint: "忠信利平の名乗り" },
      { time: 526, text: "たっぷりと！",   hint: "忠信利平のつらね終わり" },

      // 赤星十三郎（08:53〜）「またまたその次居並ぶは…」
      { time: 536, text: "待ってました！", hint: "赤星十三郎の名乗り" },
      { time: 604, text: "たっぷりと！",   hint: "赤星十三郎のつらね終わり" },

      // 南郷力丸（10:10〜）「問われて名乗るもおこがましいが…」
      { time: 614, text: "待ってました！", hint: "南郷力丸の名乗り" },
      { time: 670, text: "たっぷりと！",   hint: "南郷力丸のつらね終わり" },

      // ===== クライマックス =====
      // 五人揃っての見得（11:14〜）
      { time: 680, text: "日本一！",       hint: "五人揃いの見得" },

      // 立ち回り → 幕切れ
      { time: 760, text: "待ってました！", hint: "幕切れ" },
    ]
  }
