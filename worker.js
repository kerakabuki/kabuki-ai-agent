...
const SCENES = [
  {
    id: "demo",
    title: "デモ（サンプル）",
    videoId: "dQw4w9WgXcQ",         // ★ 実際の動画IDに差し替え
    duration: 60,                    // 秒（目安）
    cues: [
      { time: 10, text: "待ってました！", hint: "主役の登場" },
      { time: 25, text: "たっぷりと！",   hint: "見得のあと" },
      { time: 40, text: "日本一！",       hint: "名台詞のあと" },
      { time: 55, text: "待ってました！", hint: "幕切れ" },
    ]
  }
  // ★ 実際の演目を追加：
  // {
  ...
  //   duration: 300,
  //   cues: [
  //     { time: 45, text: "待ってました！", hint: "弁慶の登場" },
  //     ...
  //   ]
  // }
];
